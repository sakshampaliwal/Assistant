...
def set_volume(volume_level):
    try:
        ...
        engine.setProperty('volume', volume/100)  # Volume should be set between 0 and 1
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if 'open website' in query:
            ...
            codePath1 = r"C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\Word.lnk"
        ...
        # Add more elif conditions for new functionalities here
